                    ...
                    <div className="container">
                        <div className="display-flex-home">
                            ...
                            <div className="introduction-para">
                                ...
                                <p>I am a Software Engineer from Kolkata, West Bengal having 4.5+ years of experience in website development and maintaince.</p>
                            ...
                            <div className="card-group">
                                <div className="card" data-aos="flip-card" data-aos-duration="2000" data-aos-offset="100" data-aos-easing="ease-in-quad">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">Skilled Front-end Developer with more than 4.5 years of experience in designing, developing and maintaining responsive web applications.</p>
                                    </div>
                                </div>
